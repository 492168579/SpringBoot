...
import com.yzy.could.util.JsonUtil;
...
//		System.setProperty("hadoop.home.dir", "D:\\BaiduNetdiskDownload\\尚硅谷大数据之Hadoop视频\\2.资料\\01_jar包\\01_win10下编译过的hadoop jar包\\hadoop-2.7.2");
		Configuration configuration = new Configuration();
//		configuration.set("fs.defaultFS", hdfsPath);
		configuration.set("fs.defaultFS", "hdfs://productnn");
		configuration.set("dfs.nameservices", "productnn");
		configuration.set("dfs.ha.namenodes.productnn", "nn1,nn2"); 
		configuration.set("dfs.namenode.rpc-address.productnn.nn1", "nnn01:8020");
		configuration.set("dfs.namenode.rpc-address.productnn.nn2", "nnn02:8020");
